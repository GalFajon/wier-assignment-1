...
Embeddings are generated using transformer models. Our initial configuration used \texttt{sentence-transformers/all-MiniLM-L6-v2} and mean pooling over the token embeddings with L2 normalization. When evaluating performance, we used multiple  models, including \texttt{sentence-transformers/all-mpnet-base-v2}, \texttt{BAAI/bge-m3}, \texttt{EMBEDDIA/sloberta}, and  \texttt{cjvt/crosloengual-bert-si-nli}, to analyze quality and language coverage.
