...
\begin{itemize}
    ...
    \item \textbf{Qwen 14B}: Mean key-fact coverage 0.549, semantic score 0.67, composite quality 0.581. Hallucination rate 60\%, contradiction rate 0.05\%, major-error rate 10\%, question-address rate 95\%.
\end{itemize}
