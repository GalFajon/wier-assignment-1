...
* [x] check and FULLY respect robots.txt - respect the commands User-agent, Allow, Disallow, Crawl-delay and Sitemap
...
* [x] store canonicalized URLs only in DB
...
### DATABASE
* [x] table site contains web site specific data - DOMAIN - 24ur.com
* [ ] 
